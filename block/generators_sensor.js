...
*/
	...
	Blockly.JavaScript['dhtesp_read_temp_MySTEMIoTpro'] = function(block) {
	  var variable_instance = Blockly.JavaScript.variableDB_.getName(block.getFieldValue('instance'), Blockly.Variables.NAME_TYPE);
	  var code = `${variable_instance}.readTemperature()`;
	  return [code, Blockly.JavaScript.ORDER_ATOMIC];
	};

	Blockly.JavaScript['dhtesp_read_humid_MySTEMIoTpro'] = function(block) {
	  var variable_instance = Blockly.JavaScript.variableDB_.getName(block.getFieldValue('instance'), Blockly.Variables.NAME_TYPE);
	...
	Blockly.JavaScript['ds18b20_init_MySTEMIoTpro'] = function(block) {
	  var number_pin = block.getFieldValue('pin');
	  var code = `#EXTINC
	#include <OneWire.h>
	...
	Blockly.JavaScript['ds18b20_get_devices_num_MySTEMIoTpro'] = function(block) {
	  var code = `sensors_ds18b20.getDS18Count()`;
	  return [code, Blockly.JavaScript.ORDER_ATOMIC];
	};

	Blockly.JavaScript['ds18b20_get_temperature_MySTEMIoTpro'] = function(block) {
...
Blockly.JavaScript['ds3231_rtc_get_temp'] = function (block) {
