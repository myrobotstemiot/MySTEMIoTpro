...
/*
  ...
  Blockly.JavaScript["OLED_display_clear"] = function(block) {
  ...
  Blockly.JavaScript["OLED_display_print"] = function(block) {
...
`;
  ...
  Blockly.JavaScript["OLED_display_draw_line"] = function(block) {
  ...
  Blockly.JavaScript["OLED_display_draw_progress_bar"] = function(block) {
    var value_x = Blockly.JavaScript.valueToCode(block,
      "x",
      Blockly.JavaScript.ORDER_ATOMIC);
    var value_y = Blockly.JavaScript.valueToCode(block,
  ...
  Blockly.JavaScript["OLED_display_draw_pixel"] = function(block) {
    var value_x = Blockly.JavaScript.valueToCode(block,
      "x",
      Blockly.JavaScript.ORDER_ATOMIC);
    var value_y = Blockly.JavaScript.valueToCode(block,
...
`;
  ...
  Blockly.JavaScript["OLED_display_string_width"] = function(block) {
    var value_text = Blockly.JavaScript.valueToCode(block,
      "text",
      Blockly.JavaScript.ORDER_ATOMIC);
  ...
  Blockly.JavaScript["OLED_display_width"] = function(block) {
    var code = "display.getWidth()";
    return [code, Blockly.JavaScript.ORDER_ATOMIC];
  };

  Blockly.JavaScript["OLED_display_height"] = function(block) {
    var code = "display.getHeight()";
    return [code, Blockly.JavaScript.ORDER_ATOMIC];
  };
*/

  Blockly.JavaScript["TFT_setCursor"] = function(block) {
    var value_x = Blockly.JavaScript.valueToCode(block,"x",Blockly.JavaScript.ORDER_ATOMIC);
    var value_y = Blockly.JavaScript.valueToCode(block,"y",Blockly.JavaScript.ORDER_ATOMIC);
    var code = `gfx->setCursor(${value_x}, ${value_y});\n`;
    return code;
  };
  Blockly.JavaScript['TFT_fillScreen'] = function(block) {
  var color = block.getFieldValue('color');
  var color_sub = "0x"+color.substring(1,5);
  var code = `gfx->fillScreen(${color_sub});\n`;
  return code;
  };
  
  Blockly.JavaScript["TFT_println"] = function(block) {
    ...
    var code =`gfx->setCursor(${value_x}, ${value_y});\n
               ...
               gfx->setTextSize(${value_Size});\n
               gfx->println(${value_text});\n`;
        return code;
  };
  Blockly.JavaScript['TFT_setRotation'] = function(block) {
  var value_Rotation =block.getFieldValue('Rotation');
  var code = `gfx->setRotation(${value_Rotation});\n`;
  return code;
  };
  Blockly.JavaScript["TFT_drawPixel"] = function(block) {
    var value_x = Blockly.JavaScript.valueToCode(block,"x",Blockly.JavaScript.ORDER_ATOMIC);
    var value_y = Blockly.JavaScript.valueToCode(block,"y",Blockly.JavaScript.ORDER_ATOMIC);
    var value_Color = block.getFieldValue('Color');
    var code = `gfx->drawPixel(${value_x}, ${value_y},${value_Color});\n`;
    return code;
  };
  Blockly.JavaScript["TFT_drawRect"] = function(block) {
    var value_x = Blockly.JavaScript.valueToCode(block,"x",Blockly.JavaScript.ORDER_ATOMIC);
    var value_y = Blockly.JavaScript.valueToCode(block,"y",Blockly.JavaScript.ORDER_ATOMIC);
    ...
    var value_Color = block.getFieldValue('Color');
    var code = `gfx->drawRect(${value_x}, ${value_y},${value_w}, ${value_h},${value_Color});\n`;
    return code;
  };
  Blockly.JavaScript["TFT_fillRect"] = function(block) {
    var value_x = Blockly.JavaScript.valueToCode(block,"x",Blockly.JavaScript.ORDER_ATOMIC);
    var value_y = Blockly.JavaScript.valueToCode(block,"y",Blockly.JavaScript.ORDER_ATOMIC);
    var value_w = Blockly.JavaScript.valueToCode(block,"w",Blockly.JavaScript.ORDER_ATOMIC);
    var value_h = Blockly.JavaScript.valueToCode(block,"h",Blockly.JavaScript.ORDER_ATOMIC);
    var value_Color = block.getFieldValue('Color');
    var code = `gfx->fillRect(${value_x}, ${value_y},${value_w}, ${value_h},${value_Color});\n`;
    return code;
  };
  Blockly.JavaScript["TFT_drawCircle"] = function(block) {
    var value_x = Blockly.JavaScript.valueToCode(block,"x",Blockly.JavaScript.ORDER_ATOMIC);
    var value_y = Blockly.JavaScript.valueToCode(block,"y",Blockly.JavaScript.ORDER_ATOMIC);
    var value_r = Blockly.JavaScript.valueToCode(block,"r",Blockly.JavaScript.ORDER_ATOMIC);
    var value_Color = block.getFieldValue('Color');
    var code = `gfx->drawCircle(${value_x}, ${value_y},${value_r},${value_Color});\n`;
    return code;
  };
  Blockly.JavaScript["TFT_fillCircle"] = function(block) {
    var value_x = Blockly.JavaScript.valueToCode(block,"x",Blockly.JavaScript.ORDER_ATOMIC);
    var value_y = Blockly.JavaScript.valueToCode(block,"y",Blockly.JavaScript.ORDER_ATOMIC);
    var value_r = Blockly.JavaScript.valueToCode(block,"r",Blockly.JavaScript.ORDER_ATOMIC);
    var value_Color = block.getFieldValue('Color');
    var code = `gfx->fillCircle(${value_x}, ${value_y},${value_r},${value_Color});\n`;
    return code;
  };
  Blockly.JavaScript["TFT_drawTriangle"] = function(block) {
    ...
    var value_Color = block.getFieldValue('Color');
    var code = `gfx->drawTriangle(${value_x0}, ${value_y0},${value_x1}, ${value_y1},${value_x2}, ${value_y2},${value_Color});\n`;
    return code;
  };
  Blockly.JavaScript["TFT_fillTriangle"] = function(block) {
    var value_x0 = Blockly.JavaScript.valueToCode(block,"x0",Blockly.JavaScript.ORDER_ATOMIC);
    var value_y0 = Blockly.JavaScript.valueToCode(block,"y0",Blockly.JavaScript.ORDER_ATOMIC);
    var value_x1 = Blockly.JavaScript.valueToCode(block,"x1",Blockly.JavaScript.ORDER_ATOMIC);
    var value_y1 = Blockly.JavaScript.valueToCode(block,"y1",Blockly.JavaScript.ORDER_ATOMIC);
    ...
    var value_y2 = Blockly.JavaScript.valueToCode(block,"y2",Blockly.JavaScript.ORDER_ATOMIC);
    var value_Color = block.getFieldValue('Color');
    var code = `gfx->fillTriangle(${value_x0}, ${value_y0},${value_x1}, ${value_y1},${value_x2}, ${value_y2},${value_Color});\n`;
    return code;
  };
